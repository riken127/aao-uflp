...
#define OPTIMAL_SOLUTION 2290.164
...
int main() {
    ...
    try {
        Problem problem = parser.parse("../../../src/tests/FicheirosTeste/M/Kcapmp5.txt");
        miscellaneous::AlgorithmLogger logger("simulated_annealing_test.txt","SimulatedAnnealing","mp5");
