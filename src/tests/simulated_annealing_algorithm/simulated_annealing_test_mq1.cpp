...
#define OPTIMAL_SOLUTION 3591.273
...
int main() {
    ...
    try {
        Problem problem = parser.parse("../../../src/tests/FicheirosTeste/M/Kcapmq1.txt");
        miscellaneous::AlgorithmLogger logger("simulated_annealing_test.txt","SimulatedAnnealing","mq1");
