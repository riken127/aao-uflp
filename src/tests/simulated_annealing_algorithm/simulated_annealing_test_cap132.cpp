...
#define OPTIMAL_SOLUTION 851495.325
...
int main() {
    ...
    try {
        Problem problem = parser.parse("../../../src/tests/FicheirosTeste/ORLIB/ORLIB-uncap/130/cap132.txt");
       miscellaneous::AlgorithmLogger logger("simulated_annealing_test.txt","SimulatedAnnealing","cap132");
