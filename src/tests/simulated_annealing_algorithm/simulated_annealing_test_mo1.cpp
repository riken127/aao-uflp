...
#define OPTIMAL_SOLUTION 1156.909
...
int main() {
    ...
    try {
        Problem problem = parser.parse("../../../src/tests/FicheirosTeste/M/Kcapmo1.txt");
       miscellaneous::AlgorithmLogger logger("simulated_annealing_test.txt","SimulatedAnnealing","mo1");
