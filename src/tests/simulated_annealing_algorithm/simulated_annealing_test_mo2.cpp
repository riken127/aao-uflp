...
#define OPTIMAL_SOLUTION 1227.667
...
int main() {
    ...
    try {
        Problem problem = parser.parse("../../../src/tests/FicheirosTeste/M/Kcapmo2.txt");
        miscellaneous::AlgorithmLogger logger("simulated_annealing_test.txt","SimulatedAnnealing","mo2");
